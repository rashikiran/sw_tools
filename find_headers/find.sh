...
cat temp.txt | sort | uniq > ./include_headers_list_unprocessed.txt
...
cat res_include_headers_file_found_list.txt | sort | uniq > temp.txt

cat temp.txt > res_include_headers_file_found_list.txt

cat res_include_headers_file_not_found_list.txt | sort | uniq > temp.txt

cat temp.txt > res_include_headers_file_not_found_list.txt
